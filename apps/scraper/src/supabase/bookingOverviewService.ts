...
export class BookingOverviewService {
  ...
  async getComprehensiveBookingOverview(businessProfileId: string): Promise<{
    ...
    try {
      ...
      logger.error(
        "Error fetching comprehensive Booking.com overview:",
        error as any,
      );
      throw error;
    }
  ...
  async updateBookingOverviewStats(businessProfileId: string): Promise<void> {
    try {
      ...
      logger.info(
        `Updating Booking.com overview stats for business ${businessProfileId}`,
      );
  ...
  async getGuestTypeBreakdown(businessProfileId: string): Promise<{
    ...
    try {
      ...
      const total =
        overview.soloTravelers +
        overview.couples +
        overview.familiesWithYoungChildren +
        overview.familiesWithOlderChildren +
        overview.groupsOfFriends +
        overview.businessTravelers;
  ...
  async getStayLengthAnalysis(businessProfileId: string): Promise<{
    ...
    try {
      ...
      const totalStays =
        overview.shortStays + overview.mediumStays + overview.longStays;
