...
export class ActorJob {
    ...
    constructor(id: string, actor: Actor, data: ReviewActorJobData, run: (actor: Actor, data: ReviewActorJobData) => Promise<boolean>) {
        this.id = id;
        this.actor = actor;
        this.data = data;
...
export class Actor {
    ...
    constructor(apifyIdentifier: string, memoryEstimateMB: number, platform: MarketPlatform){
