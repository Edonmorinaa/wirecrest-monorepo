 ...
 */
export class TripAdvisorReviewRepository
  extends BaseRepository<TripAdvisorReview, string>
  implements IReviewRepository<TripAdvisorReviewWithMetadata>
{
  ...
  async update(
    id: string,
    review: Partial<TripAdvisorReviewWithMetadata>,
  ): Promise<TripAdvisorReviewWithMetadata> {
    const { reviewMetadata, ...reviewData } = review;
