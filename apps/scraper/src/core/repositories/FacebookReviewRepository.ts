 ...
 */
export class FacebookReviewRepository
  extends BaseRepository<FacebookReview, string>
  implements IReviewRepository<FacebookReviewWithMetadata>
{
  protected model = prisma.facebookReview;

  async findByBusinessId(
    businessId: string,
  ): Promise<FacebookReviewWithMetadata[]> {
  ...
  async create(
    review: Omit<FacebookReviewWithMetadata, "id" | "createdAt" | "updatedAt">,
  ): Promise<FacebookReviewWithMetadata> {
  ...
  async update(
    id: string,
    review: Partial<FacebookReviewWithMetadata>,
  ): Promise<FacebookReviewWithMetadata> {
    const { reviewMetadata, ...reviewData } = review;
