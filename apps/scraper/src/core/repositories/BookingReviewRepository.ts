...
export class BookingReviewRepository
  extends BaseRepository<BookingReview, string>
  implements IReviewRepository<BookingReviewWithMetadata>
{
  ...
  async create(
    review: Omit<BookingReviewWithMetadata, "id" | "createdAt" | "updatedAt">,
  ): Promise<BookingReviewWithMetadata> {
  ...
  async update(
    id: string,
    review: Partial<BookingReviewWithMetadata>,
  ): Promise<BookingReviewWithMetadata> {
    const { reviewMetadata, ...reviewData } = review;
