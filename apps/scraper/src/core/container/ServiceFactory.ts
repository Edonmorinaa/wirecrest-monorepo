...
export class ServiceFactory {
  ...
  private registerRepositories(): void {
    ...
    this.container.registerRepository(
      SERVICE_TOKENS.GOOGLE_BUSINESS_REPOSITORY,
      new GoogleBusinessRepository(),
    );
    this.container.registerRepository(
      SERVICE_TOKENS.GOOGLE_REVIEW_REPOSITORY,
      new GoogleReviewRepository(),
    );
    this.container.registerRepository(
      SERVICE_TOKENS.FACEBOOK_BUSINESS_REPOSITORY,
      new FacebookBusinessRepository(),
    );
    this.container.registerRepository(
      SERVICE_TOKENS.FACEBOOK_REVIEW_REPOSITORY,
      new FacebookReviewRepository(),
    );
    this.container.registerRepository(
      SERVICE_TOKENS.TRIPADVISOR_BUSINESS_REPOSITORY,
      new TripAdvisorBusinessRepository(),
    );
    this.container.registerRepository(
      SERVICE_TOKENS.TRIPADVISOR_REVIEW_REPOSITORY,
      new TripAdvisorReviewRepository(),
    );
    this.container.registerRepository(
      SERVICE_TOKENS.BOOKING_BUSINESS_REPOSITORY,
      new BookingBusinessRepository(),
    );
    this.container.registerRepository(
      SERVICE_TOKENS.BOOKING_REVIEW_REPOSITORY,
      new BookingReviewRepository(),
    );
  ...
  private registerServices(): void {
    ...
    this.container.registerService(
      ...
      new BackendOrchestrator(
        this.container,
        this.container.getService(SERVICE_TOKENS.APIFY_SERVICE),
        null,
      ),
    );
  }
