...
export class KeywordExtractor {
   ...
   */
  static extractFromReviews<
    T extends {
      text?: string | null;
      reviewMetadata?: { keywords?: string[] | null } | null;
    },
  >(reviews: T[], limit: number = 20): KeywordFrequency[] {
    const keywordMap = new Map<string, number>();
   ...
   */
  static mergeKeywordArrays(
    keywordArrays: (string[] | null)[],
  ): KeywordFrequency[] {
    const keywordMap = new Map<string, number>();
