...
export function TripAdvisorOverviewWelcome({
  displayName,
  averageRating,
  totalReviews,
  sx,
  ...
  return (
    <Box
      sx={[
        (themeStyle) => ({
          backgroundImage: [
            `linear-gradient(to right, ${themeStyle.vars.palette.background.default} 25%, ${varAlpha(themeStyle.vars.palette.primary.darkChannel, 0.88)})`,
      ...
      >
        <Stack spacing={2} sx={{ mb: 3 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            <Iconify icon="logos:tripadvisor" width={72} height={72} />

            <Box>
              <Typography variant="h4" sx={{ fontWeight: 'bold', mb: 0.5 }} color="text.primary">
                {displayName || 'TripAdvisor Business Profile'}
              </Typography>
        ...
        <Typography variant="h6" sx={{ whiteSpace: 'pre-line', mb: 2 }} color="text.primary">
          Have a look at your TripAdvisor Business Profile
        </Typography>
        ...
        >
          Get a quick overview of your TripAdvisor reviews, ratings, and customer feedback. Track
          your business reputation and see how customers are engaging with your profile.
        </Typography>
      </Box>
