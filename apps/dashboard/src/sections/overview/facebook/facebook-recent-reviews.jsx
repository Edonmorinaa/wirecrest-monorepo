...
export function FacebookRecentReviews({ businessProfile }) {
  const theme = useTheme();
  const [selectedImage, setSelectedImage] = useState(null);

  // Debug logging
  console.log('FacebookRecentReviews - businessProfile:', businessProfile);
  console.log('FacebookRecentReviews - reviews:', businessProfile?.reviews);
