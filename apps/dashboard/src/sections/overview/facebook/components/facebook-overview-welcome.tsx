...
export function FacebookOverviewWelcome({
  displayName,
  recommendationRate,
  totalReviews,
  sx,
      ...
      >
        <Stack spacing={2} sx={{ mb: 3 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            <Iconify icon="logos:facebook" width={72} height={72} />
        ...
        <Typography variant="h6" sx={{ whiteSpace: 'pre-line', mb: 2 }} color="text.primary">
          Have a look at your Facebook Business Profile
        </Typography>
        ...
        >
          Get a quick overview of your Facebook reviews, ratings, and customer feedback. Track your
          business reputation and see how customers are engaging with your profile.
        </Typography>
      </Box>
