  ...
  return (
    <DashboardContent maxWidth="xl">
      <Grid container spacing={3}>
        ...
        <Grid size={{ xs: 12 }}>
        <GoogleOverviewWelcome displayName={businessProfile?.displayName} averageRating={allTimePeriodMetrics.avgRating} totalReviews={allTimePeriodMetrics.reviewCount}  />
      </Grid>
