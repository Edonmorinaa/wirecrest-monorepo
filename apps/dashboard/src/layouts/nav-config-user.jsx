...
const ICONS = {
  ...
  automation: icon('solar:robot-bold'),
  google: (
...
/**
 * Generate user navigation data based on team slug
 * This is for regular users with team context
 */
export const getUserNavData = (teamSlug) => [
  /**
   * Overview
   */
  {
      ...
      items: [
        {
          ...
          path: paths.dashboard.automation.dashboard(teamSlug),
          icon: ICONS.dashboard,
        },
        {
          title: 'Twitter Automation',
          path: paths.dashboard.automation.twitter(teamSlug),
          icon: ICONS.automation,
          children: [
            { title: 'Twitter Profiles', path: paths.dashboard.automation.twitterProfiles(teamSlug) },
            { title: 'Twitter Alerts', path: paths.dashboard.automation.twitterAlerts(teamSlug) },
          ],
        },
      ],
    },
...
export const userNavData = getUserNavData(null);
