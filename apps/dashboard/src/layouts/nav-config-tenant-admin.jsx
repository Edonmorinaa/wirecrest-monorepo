...
const ICONS = {
  ...
  invitations: icon('solar:user-plus-bold'),
  roles: icon('solar:shield-keyhole-bold'),
  analytics: icon('solar:chart-bold'),
  reports: icon('solar:chart-2-bold'),
  integrations: icon('solar:link-round-angle-bold'),
  webhooks: icon('solar:code-bold'),
};
...
export const tenantAdminNavData = getTenantAdminNavData(null);
