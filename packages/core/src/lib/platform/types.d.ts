 ...
 */
export type PlatformType = 'GOOGLE' | 'FACEBOOK' | 'TRIPADVISOR' | 'BOOKING' | 'YELP';
export type MarketPlatform = 'GOOGLE_MAPS' | 'FACEBOOK' | 'TRIPADVISOR' | 'BOOKING' | 'INSTAGRAM' | 'TIKTOK';
export type RatingType = 'stars' | 'numeric' | 'recommendation';
export type BusinessCreationStep = 'IDENTIFIER_SETUP' | 'PROFILE_CREATION' | 'REVIEWS_FETCH' | 'ANALYTICS_SETUP' | 'COMPLETED';
export type BusinessCreationStatus = 'not_started' | 'in_progress' | 'completed' | 'failed' | 'retry';
